...
<h2 className=" text-4xl font-extrabold bg-white text-slate-950 pt-20 justify-">Payments tool for companies</h2>
<div className="flex mt-4 text-lg text-gray-700 w-1/2 justify-center text-center bg-white">Start developing with an open-source library of over 450+ UI components, sections, and pages built with the utility classes from Tailwind CSS and designed in Figma.</div>
...
<div className="flex py-16 items-center gap-10 bg-white px-6 md:px-10">
<div className="">
...
<button type="button" className=" text-white text-2xl bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg  px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
Join Now
