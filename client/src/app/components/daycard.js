...
<div className="  max-w-sm p-6 mr-10 bg-gray-800 border border-gray-200 rounded-lg shadow ">
    <a href="#">
        <h5 className="mb-2 text-2xl font-bold tracking-tight text-white"> 7 day  {params.sector}  <br/> program </h5>
    </a>
    <p className="mb-3 font-normal text-gray-300 ">Impactful Week: Joining Forces in a 7-Day NGO Immersion Program</p>
