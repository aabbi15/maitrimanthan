...
<div className="container max-w-screen-xl mx-auto px-4 bg-gray-900">
    ...
    <div className="flex flex-col lg:flex-row justify-between space-x-20">
        <div className="text-center lg:text-left mt-40">
            ...
            <a href='http://localhost:3000/user/signup'><button className="px-6 py-4 bg-info font-semibold text-white text-lg rounded-xl hover:bg-blue-700 transition ease-in-out duration-500">Get started</button></a>
        </div>
